    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (omacpIntent != null) {
            ...
            if (LogUtils.isLoggable(TAG, LogUtils.DEBUG)) {
                ...
                LogUtils.i(TAG, "onStartCommand with account");
            }
            ...
            for (Intent emailIntent : omacpList) {
                ...
                if (SMTP_APPID.equals(appId)) {
                    ...
                    if (LogUtils.isLoggable(TAG, LogUtils.DEBUG)) {
                        ...
                        LogUtils.i(TAG, "[OMACP] smtp parameters");
                    }
                    ...
                    if (LogUtils.isLoggable(TAG, LogUtils.DEBUG)) {
                        ...
                        LogUtils.i(TAG, "[OMACP] pop parameters");
                    }
                    if (isEmpty(aAuthName) || isEmpty(aAuthSecret)) {
                        return null;
                    }
...
//                    account.setStoreUri(this, uri.toString());
                    ...
                    if (LogUtils.isLoggable(TAG, LogUtils.DEBUG)) {
                        ...
                        LogUtils.i(TAG, "[OMACP] imap parameters");
                    }
                    if (isEmpty(aAuthName) || isEmpty(aAuthSecret)) {
                        return null;
                    }
    ...
    private void addAccount(Account account) {
        ...
        try {
            ...
            if (LogUtils.isLoggable(TAG, LogUtils.DEBUG)) {
                ...
                LogUtils.i(TAG, "*** Setup omcap account success, start update folder list ");
            }
