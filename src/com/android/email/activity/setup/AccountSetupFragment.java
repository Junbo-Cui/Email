...
public class AccountSetupFragment extends Fragment implements View.OnClickListener {
    ...
    protected View inflateTemplatedView(final LayoutInflater inflater, final ViewGroup container,
        ...
        TextView headlineView_pop = UiUtilities.getView(template, R.id.headline_pop);
        headlineView_pop.setVisibility(View.GONE);
        TextView headlineView = UiUtilities.getView(template, R.id.headline);
        headlineView.setTextSize(18);

        Button soft_btn = UiUtilities.getView(template, R.id.softkey_left);
        soft_btn.setText(R.string.soft_key_btn_previous);
        Button soft_select_btn = UiUtilities.getView(template, R.id.softkey_center);
        soft_select_btn.setText(R.string.soft_key_btn_select);
        soft_select_btn.setTextSize(16);       
        if (headline > 0) {
        ...
        mNextButton = UiUtilities.getView(template, R.id.softkey_right);
        //mNextButton.setOnClickListener(this);
        //mPreviousButton = UiUtilities.getView(template, R.id.previous);
        //mPreviousButton.setOnClickListener(this);
        return template;
    }
    protected View inflateTemplatedNewView(final LayoutInflater inflater, final ViewGroup container,
            final int contentLayout, final int headline) {
        final View template = inflater.inflate(R.layout.account_setup_template, container, false);
        ...
        final ViewGroup contentContainer =
                (ViewGroup) template.findViewById(R.id.new_setup_fragment_content);
        inflater.inflate(contentLayout, contentContainer, true);
