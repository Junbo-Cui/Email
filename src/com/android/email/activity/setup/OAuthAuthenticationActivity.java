...
public class OAuthAuthenticationActivity extends Activity implements
    ...
    public static final int RESULT_OAUTH_BACK = 400;
    ...
    public void onCreate(Bundle bundle) {
        ...
        //mWv.getSettings().setUserAgentString("Chrome/56.0.0.0 Mobile");
        setDesktopMode(mWv,true);
        //mWv.getSettings().setUserAgentString("Mozilla/5.0 (Linux; Android 11; U115AA Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/56.0.0.0 Mobile Safari/537.36");
    ...
    public void setDesktopMode(WebView webView,boolean enabled) {
        ...
        webView.getSettings().setUseWideViewPort(enabled); webView.getSettings().setLoadWithOverviewMode(enabled); webView.reload();
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch(keyCode){
            case KeyEvent.KEYCODE_BACK:
                ...
                setResult(RESULT_OAUTH_BACK, intent);
                finish();
                return false;
        }
        return false;
