...
import com.android.mail.browse.MessageViewDownloadRemain;
...
public class ConversationViewFragment extends AbstractConversationViewFragment implements
    ...
    public static ConversationViewState mNewViewState;
    ...
    private ViewGroup mUpperheader;
    ...
    public static Conversation mNewConversation;
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        ViewGroup customView = (ViewGroup)inflater.inflate(R.layout.conversation_message_header, null);
        mUpperheader = (ViewGroup)customView.findViewById(R.id.upper_header);
        ViewGroup customView2 = (ViewGroup)inflater.inflate(R.layout.conversation_message_footer, null);
        mAttachmentBarList = (LinearLayout) customView2.findViewById(R.id.attachment_bar_list);
        OnePaneController.MainAndReplyFlag = 1;
    ...
    public boolean onKey(View view, int keyCode, KeyEvent keyEvent) {
        ...
        if (mOriginalKeyedView != null) {
            ...
            if ((isStart || isEnd) && shouldInterceptLeftRightEvents(
                ...
                if(isUp){
                   final int mCurrentY = mWebView.getScrollY();
                   if(mUpperheader.isFocusable()&& mCurrentY == 0){
                ...
                if (next != null) {
                    ...
                    if(MessageFooterView.AttachmentListUri.size() != 0){
                       MessageAttachmentBar barAttachmentView = (MessageAttachmentBar)
                                             mAttachmentBarList.findViewWithTag(MessageFooterView.AttachmentListUri.get(0));
                       if(MessageFooterView.barAttachmentView != null ){
                            MessageFooterView.barAttachmentView.requestFocus();
                       }
                    }
