...
public class OnePaneController extends AbstractActivityController {
    ...
    public static int MainAndReplyFlag = 0;
    public static String ACTION_BAR_TITLE_FOLDER = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerContainer = (HomeDrawerLayout) mActivity.findViewById(R.id.drawer_container);
        MailActivity mainActivity = new MailActivity();
        mainActivity.SetActionBarTitle(mActivity.getResources().getString(R.string.mailbox_name_display_inbox));
        mDrawerContainer.setDrawerTitle(Gravity.BOTTOM,
    ...
    protected void showConversation(Conversation conversation, boolean shouldAnimate) {
        ...
        Log.i("lhz1220","shouldAnimate:"+shouldAnimate);
        Button soft_btn = mActivity.findViewById(R.id.softkey_left);
        soft_btn.setText(R.string.notification_action_reply);
    ...
    private int replaceFragment(Fragment fragment, int transition, String tag, int anchor) {
        final FragmentManager fm = mActivity.getFragmentManager();
        Button soft_btn = mActivity.findViewById(R.id.softkey_left);
        Log.i("lhz1220","transition:"+transition+"  "+tag);
        soft_btn.setText(R.string.bottom_new);
        MailActivity mainActivity = new MailActivity();
        if(ACTION_BAR_TITLE_FOLDER!=null){    
          mainActivity.SetActionBarTitle(ACTION_BAR_TITLE_FOLDER);
        }else{
          mainActivity.SetActionBarTitle(mActivity.getResources().getString(R.string.mailbox_name_display_inbox));
        }
        /**
