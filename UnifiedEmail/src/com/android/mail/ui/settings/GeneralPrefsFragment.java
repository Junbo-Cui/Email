...
public class GeneralPrefsFragment extends MailPreferenceFragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mLayoutInflat = inflater;
        final ActionBar actionBar = getActivity().getActionBar();
        if (actionBar != null) {
            ViewGroup customView = (ViewGroup) inflater.inflate(R.layout.actionbar_title, null);
            TextView mtextView = customView.findViewById(R.id.actionbar_center_title);
            mtextView.setText(R.string.general_preferences_title);
