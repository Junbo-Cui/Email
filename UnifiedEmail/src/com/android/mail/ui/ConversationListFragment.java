...
public final class ConversationListFragment extends Fragment implements
    ...
    public static Folder mSelectFolder;
    ...
    private class ConversationCursorObserver extends DataSetObserver {
        ...
        public void onChanged() {
            Log.i("lhz0330","ConversationCursorObserver");
        ...
        mFolderObserver = new FolderObserver() {
            ...
            public void onChanged(Folder newFolder) {
                if(mSelectFolder != null){
                    Log.i("lhz0330","mSelectFolder != null:"+mSelectFolder.name);
            mActivity.getAccountController().closeDrawer(true /** hasNewFolderOrAccount */,
                    null /** nextAccount */,
                    mSelectFolder /** nextFolder */);
            Analytics.getInstance().sendEvent("switch_folder", mSelectFolder.getTypeDescription(),
                    "recent", 0);
                    //Analytics.getInstance().sendEvent("view_folder", f.getTypeDescription(),
                    //Long.toString(countLog), f.totalCount);
                }else{
                    Log.i("lhz0330","mSelectFolder == null22222222:");
...
//            outState.putInt(CHOICE_MODE_KEY, mListView.getChoiceMode());
    ...
    private void showList() {
        ...
        Log.i("lhz0330","showList:"+mActivity.getFolderController().getFolder().name);
        onConversationListStatusUpdated();
