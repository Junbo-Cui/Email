...
class AccountDrawerItem extends DrawerItem {
    ...
    public View getView(View convertView, ViewGroup parent) {
        ...
        accountItemView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                TextView displayMame =accountItemView.findViewById(R.id.account_display_name);
                TextView displayAddr =accountItemView.findViewById(R.id.account_address);
                if(hasFocus) {
                    displayMame.setTextColor(Color.parseColor("#FFFFFF"));
                    displayAddr.setTextColor(Color.parseColor("#FFFFFF"));
                } else {
                    displayMame.setTextColor(Color.parseColor("#000000"));
                    displayAddr.setTextColor(Color.parseColor("#000000"));
                }
            }
        });
