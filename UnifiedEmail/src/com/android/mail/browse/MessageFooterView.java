...
public class MessageFooterView extends LinearLayout implements DetachListener,
    ...
    public static List<Uri> AttachmentListUri = new ArrayList();
    public static  MessageAttachmentBar barAttachmentView;
    private void renderBarAttachments(List<Attachment> barAttachments, boolean loaderResult) {
        ...
        barAttachmentView.setFocusable(true);
        //barAttachmentView.requestFocus();
        }
    }
