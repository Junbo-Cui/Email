...
public class ConversationPagerController {
    ...
    public void show(Account account, Folder folder, Conversation initialConversation,
        ...
        mShown = true;
        /*final int cov_pos = mPagerAdapter.getConversationPosition(initialConversation);
        Fragment fragment = mPagerAdapter.getItem(cov_pos);
        Fragment listFragment = ((AbstractActivityController)mActivityController).getConversationListFragment();
        if (fragment != null) {
            LogUtils.d(LOG_TAG, "show fragment %s: " + fragment.getClass().getName());
        }
        if (listFragment != null) {
            LogUtils.d(LOG_TAG, "show listFragment %s: " + listFragment.getClass().getName());
        }
        mFragmentManager.beginTransaction().remove(listFragment).commitAllowingStateLoss();*/
    }
