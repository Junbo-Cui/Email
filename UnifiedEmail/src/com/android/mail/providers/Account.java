    ...
    public synchronized String serialize() {
        ...
        try {
            ...
            if (LogUtils.isLoggable(LOG_TAG, LogUtils.DEBUG)) {
                ...
                LogUtils.wtf(LOG_TAG, e, "Could not serialize account");
            }
        }
    ...
    public static Account newInstance(String serializedAccount) {
        ...
        try {
            ...
            if (LogUtils.isLoggable(LOG_TAG, LogUtils.DEBUG)) {
                ...
                LogUtils.w(LOG_TAG, e, "Could not create an account from this input");
            }
            return null;
        }
    }
            ...
            if (!TextUtils.isEmpty(accountFromAddresses)) {
                try {
                    ...
                    if (LogUtils.isLoggable(LOG_TAG, LogUtils.DEBUG)) {
                        ...
                        LogUtils.e(LOG_TAG, e, "Unable to parse accountFromAddresses");
                    }
                }
            }
        }
